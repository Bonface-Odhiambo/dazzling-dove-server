...
(
    ...
    background_color character varying(7) COLLATE pg_catalog."default" DEFAULT '#ffffff'::character varying,
    text_color character varying(7) COLLATE pg_catalog."default" DEFAULT '#000000'::character varying,
...
COMMENT ON TABLE banners
    IS 'Hero section banners and carousel slides for homepage display';

COMMENT ON COLUMN banners.title
    IS 'Main title/headline of the banner';

COMMENT ON COLUMN banners.subtitle
    IS 'Secondary text below the title';

COMMENT ON COLUMN banners.description
    IS 'Detailed description or promotional text';

COMMENT ON COLUMN banners.image_url
    IS 'URL/path to the banner background image';

COMMENT ON COLUMN banners.button_text
    IS 'Text for the call-to-action button';

COMMENT ON COLUMN banners.button_link
    IS 'URL that the button should link to';

COMMENT ON COLUMN banners.display_order
    IS 'Order in which banners should be displayed (lower numbers first)';

COMMENT ON COLUMN banners.is_active
    IS 'Whether this banner is currently active and should be displayed';

COMMENT ON COLUMN banners.background_color
    IS 'Hex color code for banner background overlay';

COMMENT ON COLUMN banners.text_color
    IS 'Hex color code for banner text';

COMMENT ON COLUMN banners.created_by
    IS 'Admin user who created this banner';
